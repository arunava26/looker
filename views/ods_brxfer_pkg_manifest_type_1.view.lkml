# The name of this view in Looker is "Ods Brxfer Pkg Manifest Type 1"
view: ods_brxfer_pkg_manifest_type_1 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ODS_PROD.ODS_BRXFER_PKG_MANIFEST_TYPE_1`
    ;;
