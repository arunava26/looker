# The name of this view in Looker is "Ims Cust Cusmsc Tax Xmpt X"
view: ims_cust_cusmsc_tax_xmpt_x {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ODS_PROD.IMS_CUST_CUSMSC_TAX_XMPT_X`
    ;;
  ...
  dimension: contribuinte_sw {
    type: string
    sql: ${TABLE}.CONTRIBUINTE_SW ;;
  }
  ...
  dimension: exempt_suffix {
    type: string
    sql: ${TABLE}.EXEMPT_SUFFIX ;;
  }
