# The name of this view in Looker is "Ods Po Drct Po Ship To"
view: ods_po_drct_po_ship_to {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ODS_PROD.ODS_PO_DRCT_PO_SHIP_TO`
    ;;
  ...
  dimension: emal_addr_txt {
    type: string
    sql: ${TABLE}.EMAL_ADDR_TXT ;;
  }
  ...
  dimension: ship_to_co_nam {
    type: string
    sql: ${TABLE}.SHIP_TO_CO_NAM ;;
  }
