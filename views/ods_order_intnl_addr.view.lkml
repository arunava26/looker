# The name of this view in Looker is "Ods Order Intnl Addr"
view: ods_order_intnl_addr {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ODS_PROD.ODS_ORDER_INTNL_ADDR`
    ;;
  ...
  # This dimension will be called "Attn Fax Nbr" in Explore.

  dimension: attn_fax_nbr {
    type: string
    sql: ${TABLE}.ATTN_FAX_NBR ;;
  }

  dimension: attn_mobl_nbr {
    type: string
    sql: ${TABLE}.ATTN_MOBL_NBR ;;
  }
  ...
  dimension: cd_page_nbr {
    type: number
    sql: ${TABLE}.CD_PAGE_NBR ;;
  }
  ...
  measure: total_cd_page_nbr {
    type: sum
    sql: ${cd_page_nbr} ;;
  }

  measure: average_cd_page_nbr {
    type: average
    sql: ${cd_page_nbr} ;;
  }
  ...
  dimension: ship_addr_3_line {
    type: string
    sql: ${TABLE}.SHIP_ADDR_3_LINE ;;
  }
