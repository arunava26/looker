# The name of this view in Looker is "Ims Order Shipaddr Orssto M"
view: ims_order_shipaddr_orssto_m {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ODS_PROD.IMS_ORDER_SHIPADDR_ORSSTO_M`
    ;;
  ...
  dimension: ccs_encryption_key {
    type: string
    sql: ${TABLE}.CCS_ENCRYPTION_KEY ;;
  }
