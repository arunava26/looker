# The name of this view in Looker is "Ims Order Line Serial Orscap S"
view: ims_order_line_serial_orscap_s {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ODS_PROD.IMS_ORDER_LINE_SERIAL_ORSCAP_S`
    ;;
