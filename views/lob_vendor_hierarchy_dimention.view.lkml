# The name of this view in Looker is "Lob Vendor Hierarchy Dimention"
view: lob_vendor_hierarchy_dimention {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ODS_PROD.LOB_VENDOR_HIERARCHY_DIMENTION`
    ;;
