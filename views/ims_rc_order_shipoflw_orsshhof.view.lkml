# The name of this view in Looker is "Ims Rc Order Shipoflw Orsshhof"
view: ims_rc_order_shipoflw_orsshhof {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ODS_PROD.IMS_RC_ORDER_SHIPOFLW_ORSSHHOF`
    ;;
